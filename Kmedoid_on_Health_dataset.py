...
x_train_main = main_database.sample(frac=0.7, random_state=0)
x_test = main_database.drop(x_train_main.index)
death = x_train_main["DEATH_EVENT"].tolist()
x_train = x_train_main.drop(["DEATH_EVENT"],axis=1)
